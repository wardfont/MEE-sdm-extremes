...
#' Spatially blocked partition and random partitioning
#' .. content for \details{} ..
#'
#' @title
#' @param euforest_rep
...
partition_euforest_biovars <- function(euforest_rep, rep, env_files, min_occ_prop, k_sblock, k_random) {
  conflict_prefer("select", "dplyr")
  conflict_prefer("filter", "dplyr")
